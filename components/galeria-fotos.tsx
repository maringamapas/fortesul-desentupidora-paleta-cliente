...
const galleryData: GalleryImage[] = [
  {
    ...
    alt: "Equipe instalando banheiros químicos em canteiro de obras",
    title: "Locação de Banheiros",
    span: "col-span-1"
  },
  {
    id: 2,
    src: "/images/galeria-2.jpg",
    alt: "Caminhão vácuo-compressor realizando limpeza de fossa",
    title: "Limpa Fossa",
    span: "col-span-2"
  },
  {
    ...
    alt: "Técnico realizando desentupimento de drenagem",
  ...
  },
  {
    ...
    alt: "Fileira de banheiros químicos em evento",
    title: "Banheiros para Eventos",
    span: "col-span-1"
  },
]
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
              Confira alguns dos nossos serviços em ação: locação de banheiros químicos, limpeza de fossa e desentupimento
            </p>
          </div>
