          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="relative h-24 md:h-32 rounded-md overflow-hidden">
              <Image
                ...
                alt="Caminhão limpa fossa realizando esgotamento de fossa séptica"
                fill
            ...
            <div className="relative h-24 md:h-32 rounded-md overflow-hidden">
              <Image
                ...
                alt="Fileira de banheiros químicos para eventos e obras"
                fill
                sizes="(max-width: 1024px) 50vw, 25vw"
                className="object-cover"
              />
            ...
            <div className="col-span-2 relative h-24 md:h-32 rounded-md overflow-hidden">
              <Image
                ...
                alt="Técnico realizando hidrojateamento para desentupimento de tubulação"
                fill
